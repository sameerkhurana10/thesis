...
public class MatrixHelper {
	 ...
	 *
	 * @param matrix
	 *            The DoubbleMatrix2D object to print
	 */
	 ...
	 * @return a + b
	 */
	public static DoubleMatrix1D addVectors(DoubleMatrix1D a, DoubleMatrix1D b) throws IllegalArgumentException {
	 ...
	 * @return a - b.
	 */
	public static DoubleMatrix1D subVectors(DoubleMatrix1D a, DoubleMatrix1D b) throws IllegalArgumentException {
	 ...
	 *            The matrix.
	 * @param B
	 *            The vector to append to A.
	 * @throws IllegalArgumentException
	 *             if A.rows() != B.size()
	 * @return A matrix
	 */
	public static DoubleMatrix2D appendToMatrix(DoubleMatrix2D A, DoubleMatrix1D B) throws IllegalArgumentException {
	 ...
	 * @return A + B
	 */
	public static DoubleMatrix2D addMatrices(DoubleMatrix2D A, DoubleMatrix2D B) throws IllegalArgumentException {
