...
public class PennTreebankCollinsHeadFinder extends AbstractHeadFinder {
	public PennTreebankCollinsHeadFinder() {
		// this.tlp = tlp;
		setCategoriesToAvoid(new String[] {});

		nonTerminalInfo = new ConcurrentHashMap<String, String[][]>();
		...
		nonTerminalInfo.put("TYPO", new String[][] { { "left" } }); // another
																	...
																	// Brown
																	// (Roger)
		nonTerminalInfo.put("EDITED", new String[][] { { "left" } }); // crap
																		// rule
																		// for
																		// Switchboard
																		// (if
																		...
																		// EDITED
																		// nodes)
		nonTerminalInfo.put("XS", new String[][] { { "right", "IN" } }); // rule
																			// for
																			// new
																			// structure
																			// in
	...
	public boolean isPunctuationTag(String label) {
		...
		if (label.equals("''")) { return true; }
		if (label.equals(".")) { return true; }
		if (label.equals("PUNC")) { return true; }
